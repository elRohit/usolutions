document.addEventListener("DOMContentLoaded", () => {
  ...
  function simulateStepProgression(steps) {
    ...
    const stepTimes = [
      3000, // Step 1: Initializing server
      5000, // Step 2: Configuring server
      4000, // Step 3: Installing software
      3000, // Step 4: Setting up database
      2000, // Step 5: Finalizing installation
    ]
  ...
  function startRedirectCountdown(countdownElement) {
    let seconds = 5 // Default to 5 seconds
  
    // Try to parse the initial value if it exists
    const initialValue = Number.parseInt(countdownElement.textContent, 10)
